...
class MonocraticaPage extends BasePage {
    ...
    pathProcesso = '//*[@id="scrollId"]/div/div[2]/div/div[1]/div[1]/h4[1]';
    pathClasse = '/html/body/app-root/app-home/main/app-search-detail/div/div/div[2]/div/div[1]/div[1]/h4[2]';
    pathRelator = '/html/body/app-root/app-home/main/app-search-detail/div/div/div[2]/div/div[1]/div[1]/h4[3]';
    pathDataJulgamento = '//*[@id="scrollId"]/div/div[2]/div/div[1]/div[1]/div/h4[1]';
    pathDataPublicacao = '//*[@id="scrollId"]/div/div[2]/div/div[1]/div[1]/div/h4[2]';
    pathPartes = '/html/body/app-root/app-home/main/app-search-detail/div/div/div[2]/div/div[3]/div';
    pathDecisaoJurisprudencia = '//*[@id="decisaoTexto"]';
    pathIconeAcompanhamentoProcessual = '/html/body/app-root/app-home/main/app-search-detail/div/div/div[2]/div/div[1]/div[2]/div/mat-icon[1]';
